...
const Hero = () => {
  ...
  return (
    <section className="relative bg-slate-950 overflow-hidden min-h-[85vh] flex items-center">
      <div className="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8 py-6 sm:py-12 md:py-20 lg:py-24">
            ...
            <div className="space-y-6 lg:space-y-8 flex-1 flex flex-col justify-between">
              ...
              <div className="mt-6 pt-6 border-t border-slate-700">
                <div className="grid grid-cols-4 gap-8">
                  ...
                  <div className="flex flex-col items-center justify-start border-l-2 border-slate-700 pl-6">
