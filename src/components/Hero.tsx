              ...
              <div className="flex flex-col sm:flex-row sm:flex-wrap justify-center gap-3">
                {benefits.map((benefit) => {
                  ...
                  return (
                    <div
                      key={benefit.id}
                      className="w-full sm:w-auto sm:max-w-[270px] mx-auto flex items-center justify-center gap-3 rounded-full bg-white/5 border border-white/10 px-4 py-2.5 text-center"
                    >
                      <BenefitIcon
                        size={18}
                        weight="duotone"
                        ...
                        aria-hidden="true"
                      />
                      <span className="text-[13px] leading-snug text-slate-300 break-words">
                        {benefit.label}
                      </span>
                    </div>
                  );
